...
One layer up, a pragmatic speaker, $S_1$, chooses utterances in proportion to their utility. Utterances are useful to the extent that they maximize the probability that $L_0$ will infer the correct $s$ on the basis of $u$ while minimizing the cost of $u$ (speakers are lazy). So, when selecting utterances, $S_1$ considers their affect on interpretation (i.e., on $L_0$'s resulting beliefs).
