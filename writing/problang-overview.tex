...
One of the more ingenious---and abstract---state implementations comes from the generics model. Generic statements update beliefs about the prevalence of a feature in a category (e.g., the \% of robins that lay eggs). The prior, then, is a distribution over prevalence. \cite{tesslergoodman2019} treat this distribution as a distribution over alternative categories, akin to the implementation of the comparison class in the vague adjectives models \citep{lassitergoodman2013, tessler2017comparisonclass}. These distributions have complex structures, reflecting abstract, intuitive theories about categories and properties, which can also be well-modeled using the tools of probabilistic calculus \citep{tenenbaum2011grow}. 
