...
\subsection{Meaning inference} \label{meaning_inference}
...
In Section \ref{meaning_inference}, we described a model of gradable adjectives where the threshold for \emph{tall} is computed via reference to the state prior, the prior distribution over heights within some comparison class. We can make this dependence on the comparison class $c$ explicit in the model of the speaker: 
