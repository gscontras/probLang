...
\begin{itemize}
  \item \citet{Monroe:Potts:2015} explore how to set-up a model in which RSA-style literal and pragmatic language agents learn underlying semantic meaning associations based on data from the TUNA corpus \cite{DeemterSluis2006:Building-a-Sema}, i.e., human data from tasks similar to the reference game from Section~\ref{overview}. \citet{Monroe:Potts:2015} show that pragmatic agents outperform literal language users in their set-up.
  \item \citep{Monroe:Hawkins:Goodman:Potts:2017}
  \item \citep{AndreasKlein2016:Reasoning-about}
  \item A number of papers have shown how building pragmatic audience design in the vein of an RSA speaker rule into NLP systems amplifies performance in a number of different applications, such as route descriptions \citep{FriedHu2018:Speaker-Followe}, summarization and abstraction \citep{ShenFried2019:Pragmatically-I}, or image captioning \citep{Cohn-GordonGoodman2018:Pragmatically-I,NieCohn-Gordon2020:Pragmatic-Issue}.
\end{itemize}
