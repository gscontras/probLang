...
High-level overview of framework / Vanilla RSA

MF’s math (derivable from KL, connection to Grice maxims)

Variations on vanilla (normally we don’t do this at the same time because it’s not necessary and it gets confusing)

Lexical inference type models: write like this, useful for this, have the following goodies..

QUD inference

Context / Prior inference

Epistemic inference

Complex utility / utilty inference
