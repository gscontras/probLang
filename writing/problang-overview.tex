...
One of the more ingenious---and abstract---state implementations comes from the generics model. \gcs{a note about the states in the generics model?}
...
Having decided what the relevant alternatives are and how to model them, the task then turns to implementing the appropriate prior: beliefs about which alternatives are more or less likely a priori.

Like the specific probabilities assigned in the various priors, other free parameters of the model must be fixed in order to generate predictions. 
