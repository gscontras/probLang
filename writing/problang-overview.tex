...
In the pizza example, the relevant inference concerns how likely it is for the listener to strengthen the ``some'' utterance to ``some but not all.'' \cite{goodmanstuhlmuller2013} 

\gcs{}- scalar implicature model

\gcs{}- plural predication model
