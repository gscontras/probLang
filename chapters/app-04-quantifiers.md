...
Here is a version of the scalar implicature model for a state space of $$\{0, 1, \dots, 432 \}$$ red circles and the above utterance set. 
...
viz.density(perceivedState(1))
viz.density(perceivedState(431))
~~~~
